...
#define INT_CHARGE_Pin GPIO_PIN_12
#define INT_CHARGE_GPIO_Port GPIOA
...
#define INT_CHARGE_EXTI_IRQn EXTI15_10_IRQn

#define BSP_CHARGE_IRQ_PRIORITY      1
#define BSP_CHARGE_IRQ_SUB_PRIORITY  1
// clock
